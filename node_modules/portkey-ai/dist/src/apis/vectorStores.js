...
class VectorStores extends apiResource_1.ApiResource {
    ...
    create(_body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            const result = yield OAIclient.beta.vectorStores
                .create(body, opts)
                .withResponse();
...
class Files extends apiResource_1.ApiResource {
    create(vectorStoreId, _body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.files
    ...
    createAndPoll(vectorStoreId, _body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.files.createAndPoll(vectorStoreId, body, opts);
            return result;
        });
    }
    poll(vectorStoreId, fileId, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.files.poll(vectorStoreId, fileId, opts);
            return result;
        });
    }
    upload(vectorStoreId, file, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.files.upload(vectorStoreId, file, opts);
            return result;
        });
    }
    uploadAndPoll(vectorStoreId, file, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.files.uploadAndPoll(vectorStoreId, file, opts);
            return result;
        });
    }
}
...
class FileBatches extends apiResource_1.ApiResource {
    create(vectorStoreId, _body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.fileBatches
                .create(vectorStoreId, body, opts)
                .withResponse();
            return (0, utils_1.finalResponse)(result);
        });
    ...
    createAndPoll(vectorStoreId, _body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.fileBatches.createAndPoll(vectorStoreId, body, opts);
            return result;
        });
    }
    ...
    poll(vectorStoreId, batchId, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.fileBatches.poll(vectorStoreId, batchId, opts);
            return result;
        });
    }
    uploadAndPoll(vectorStoreId, { files, fileIds = [] }, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.beta.vectorStores.fileBatches.uploadAndPoll(vectorStoreId, { files, fileIds }, opts);
            return result;
        });
    }
}
